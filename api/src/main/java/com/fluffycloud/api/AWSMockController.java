...
public class AWSMockController
{
	...
	public String startInstances(@Valid @RequestBody CommonRequestParams params) throws FluffyCloudException
	{
	...
	@RequestMapping(value = "/aws/ec2/createinstance", method = POST)
	public String createInstance(@Valid CommonRequestParams params,
